...
CSRF_TRUSTED_ORIGINS = ['ecommerce-website-production-3edd.up.railway.app', 'https://ecommerce-website-production-3edd.up.railway.app']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': os.environ.get('DB_PASSWORD_NEW'),
